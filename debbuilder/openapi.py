...
OPERATION_DOCS = {
    ...
    "observations.refresh": _doc(200, "ObservationResponse", "EmptyRequest", errors={400: ("invalid_observation_refresh_request", "invalid_recipe_id"), 404: ("recipe_not_found",), 409: ("recipe_changed_during_detection",), 502: ("upstream_unavailable",)}),
    ...
    "recipes.validate": _doc(200, "RecipeValidationResponse", "RecipeInput", errors={422: ("invalid_recipe_json", "unknown_field", "unsupported_recipe_schema", "invalid_automation_policy")}),
    "recipes.import": _doc(200, "RecipeImportResponse", "RecipeImportInput", errors={403: ("readonly_recipe",), 409: ("recipe_exists", "builtin_recipe_reserved"), 422: ("invalid_recipe_json", "unsupported_recipe_schema", "unknown_field")}),
    "executions.run": _doc(202, "RunAdmissionResponse", "RunInput", errors={400: ("invalid_request",), 409: ("recipe_disabled",), 422: ("unsupported_recipe_schema", "unknown_field"), 429: ("execution_queue_full",), 500: ("execution_enqueue_failed",), 503: ("execution_manager_unavailable",)}),
    "archives.inspect": _doc(200, "ArchiveInspectionResponse", "ArchiveInspectInput", errors={422: ("invalid_recipe_json", "ambiguous_archive_source", "release_asset_not_found")}),
    ...
    "workflows.save": _doc(200, "WorkflowSaveResponse", "WorkflowSaveInput", errors={403: ("forbidden",), 409: ("builtin_recipe_managed_field", "builtin_recipe_reserved"), 422: ("invalid_recipe_json", "recipe_identity_mismatch", "unknown_field")}),
