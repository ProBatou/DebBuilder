...
const allow=new Set(['libexample.so.1','DEPENDENCY_UNRESOLVED','· archive-agent 5.0.0-3','[09:42:04] unresolved: libexample.so.1','DebBuilder','DebBuilder Repository','/etc/apt/sources.list.d/debbuilder.sources','stable · amd64','Luminous · amd64','Luminous · main · amd64','Luminous','v1.0.0','stable · main · amd64','stable','main','amd64','amd64 · all','repository.gpg · InRelease','InRelease','v3.1.4 · zoraxy_linux_amd64','libc6, libssl3','ca-certificates','libc6, libssl3, ca-certificates','debbuilder · 1.0.0','all','arm64','armhf','tar.gz','zip','tag','release name','regex','simple','exec','forking','oneshot','notify','dbus','on-failure','always','no','0755','0750','0700','0644','0640','0600','After','Wants','Requires','Conflicts','RestartSec','TimeoutStartSec','TimeoutStopSec','KillSignal','StandardOutput','StandardError','LimitNOFILE','KillMode','AmbientCapabilities','ExecStartPre','ExecStartPost','ExecStop','control-group','mixed','process','none','manual','detect','test','build','build_validate','full','/opt/debbuilder','debbuilder.service','ProBatou/DebBuilder · GitHub','owner/repository','/opt/package','required','important','standard','optional','extra']);
