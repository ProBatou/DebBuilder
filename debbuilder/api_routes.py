...
ADMIN_API_ROUTES: tuple[ApiRoute, ...] = (
    ...
    _route("GET", "/api/system/diagnostics", "system.diagnostics", "_get_system_diagnostics", R, "system", "Get bounded system diagnostics"),
    _route("GET", "/api/support-bundle", "support_bundle.get", "_get_support_bundle", R, "system", "Download a bounded support bundle"),
    ...
    _route("GET", "/api/executions/{run_id}/inspect", "executions.inspect", "_get_run_inspection", R, "executions", "Inspect one Run safely"),
