    ...
    return {
        **pkg,
        "source": {
            ...
            "payload_kind": src.get("payload_kind", ""),
            "file_count": src.get("file_count"),
            "extracted_file_count": src.get("extracted_file_count"),
            "archive_format": src.get("archive_format", ""),
            "sha256": src.get("sha256", ""),
            "expected_sha256": src.get("expected_sha256", ""),
            "checksum_verified": src.get("checksum_verified", False),
        },
        "version": {
