...
class RecipeMigrationTests(unittest.TestCase):
    ...
    def test_v3_to_v4_is_pure_idempotent_and_rejects_ambiguous_field(self):
        source = fixture("current-v3.json")
        original = copy.deepcopy(source)
        migrated = migrate_v3_to_v4(source)
        ...
        self.assertEqual(raised.exception.path, "$.runtime_apt_repositories")
